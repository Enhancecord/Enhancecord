...
export const shikiWorkerSrc = `https://unpkg.com/@supercord/shiki-worker@0.0.9/dist/${IS_DEV ? "index.js" : "index.min.js"}`;
export const shikiOnigasmSrc = "https://unpkg.com/shiki@0.14.7/dist/onig.wasm";
