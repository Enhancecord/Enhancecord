...
function Updater() {
    ...
    return (
        <SettingsTab title="Enhancecord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Enhancecord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Enhancecord automatically updates"
