...
function EnhancecordSettings() {
    ...
    return (
        <SettingsTab title="Enhancecord Settings">
            ...
            <Forms.FormSection className={Margins.top16} title="Enhancecord Notifications" tag="h5">
                <Flex>
...
export default wrapTab(EnhancecordSettings, "Enhancecord Settings");
