...
import { EnhancecordDevsById, VencordDevsById } from "@utils/constants";
...
function ContributorModal({ user }: { user: User; }) {
    ...
    const plugins = useMemo(() => {
        ...
        const pluginsByAuthor = VencordDevsById[user.id] || EnhancecordDevsById[user.id]
            ? allPlugins.filter(p => p.authors.includes(VencordDevsById[user.id] || EnhancecordDevsById[user.id]))
    ...
    const ContributedHyperLink = <Link href="https://github.com/Enhancecord/Enhancecord">contributed</Link>;
