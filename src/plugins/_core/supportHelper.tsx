...
const TrustedRolesIds = [
    ...
    "1287079931645263968", // Enhancebop Contributor
...
async function generateDebugInfoMessage() {
    ...
    const client = (() => {
        ...
        if (IS_ENHANCEBOP) return `Enhancebop v${VesktopNative.app.getVersion()}`;
    ...
    commands: [
        {
            ...
            // @ts-ignore
            predicate: ctx => isPluginDev(UserStore.getCurrentUser()?.id) || isEnhancecordPluginDev(UserStore.getCurrentUser()?.id) || GUILD_ID === ctx?.guild?.id,
