...
migratePluginSettings("EnhancecordToolbox", "VencordToolbox");
export default definePlugin({
    name: "EnhancecordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Enhancecord quick actions",
