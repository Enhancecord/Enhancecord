...
const settings = definePluginSettings({
    showEnhancecordDonor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Enhancecord Donor badges in chat.",
        hidden: true,
        default: true
    },
    EnhancecordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Enhancecord Donor badges.",
        hidden: true,
        default: 0
    },
    showEnhancecordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Enhancecord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    EnhancecordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Enhancecord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://i.imgur.com/KsxHlbD.png", shown: settings.store.showEnhancecordDonor, title: "Enhancecord donor badges", key: "EnhancecordDonor", position: settings.store.EnhancecordDonorPosition },
        { src: "https://i.imgur.com/rJDRtUB.png", shown: settings.store.showEnhancecordContributor, title: "Enhancecord contributor badge", key: "EnhancecordContributer", position: settings.store.EnhancecordContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "EnhancecordDonor":
                    settings.store.EnhancecordDonorPosition = image.position;
                    settings.store.showEnhancecordDonor = image.shown;
                    break;
                case "EnhancecordContributer":
                    settings.store.EnhancecordContributorPosition = image.position;
                    settings.store.showEnhancecordContributor = image.shown;
                    break;
                case "VencordDonor":
