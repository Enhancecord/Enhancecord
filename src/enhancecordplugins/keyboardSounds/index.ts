...
export default definePlugin({
    ...
    start: () => {
        click1 = new Audio("https://github.com/Enhancecord/Equibored/raw/main/sounds/keyboard/click1.wav");
        click2 = new Audio("https://github.com/Enhancecord/Equibored/raw/main/sounds/keyboard/click2.wav");
        click3 = new Audio("https://github.com/Enhancecord/Equibored/raw/main/sounds/keyboard/click3.wav");
        backspace = new Audio("https://github.com/Enhancecord/Equibored/raw/main/sounds/keyboard/backspace.wav");
        sounds = {
            click1,
            click2,
            click3,
