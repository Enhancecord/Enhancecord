...
const settings = definePluginSettings({
    imageSource: {
        ...
        default: "https://github.com/Enhancecord/Equibored/blob/main/misc/troll.gif?raw=true"
    },
    audioSource: {
        type: OptionType.STRING,
        description: "Sets the audio url of the jumpscare",
        default: "https://github.com/Enhancecord/Equibored/raw/main/misc/trollolol.mp3?raw=true"
    },
    chance: {
