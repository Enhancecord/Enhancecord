...
export function _getBadges(args: BadgeUserArgs) {
    ...
    const enhancecordDonorBadges = (Plugins.BadgeAPI as unknown as typeof import("../plugins/_api/badges").default).getEnhancecordDonorBadges(args.userId);
    if (donorBadges) badges.unshift(...donorBadges);
    if (enhancecordDonorBadges) badges.unshift(...enhancecordDonorBadges);
