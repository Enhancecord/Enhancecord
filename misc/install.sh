...
# Constants
INSTALLER_PATH="$HOME/.enhancelotl"
GITHUB_URL="https://github.com/Enhancecord/Enhancelotl/releases/latest/download/EnhancelotlCli-Linux"
...
echo "Modified by PhoenixAceVFX & Crxaw for Enhancecord Updater"
